...
const splashLogo = require('@/assets/images/brand/splash-logo.png');
  ...
  if (step === 'splash') {
    return (
      <ImageBackground
        source={landscape}
        resizeMode="cover"
        style={[styles.splashScreen, { backgroundColor: colors.background }]}
        imageStyle={styles.splashBackgroundImage}
        testID="splash-screen"
        accessibilityLabel="Landscape background"
      >
        <StatusBar style="dark" />
        <LinearGradient
          colors={['rgba(248, 249, 244, 0.72)', 'rgba(248, 249, 244, 0.58)']}
